...
class Community_Perfomance extends StatefulWidget {
  const Community_Perfomance({super.key});

  @override
  State<Community_Perfomance> createState() => _Community_PerfomanceState();
}

class _Community_PerfomanceState extends State<Community_Perfomance> {
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: AssetImage(
                                  'assets/community/performance_${i + 1}.png'),
                              fit: BoxFit.cover),
                        ),
                        child: Stack(
                          children: [
